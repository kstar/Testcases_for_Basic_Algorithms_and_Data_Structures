...
void quickSortLomuto( std::vector<int> &v ) {
    // Implement quick sort with Lomuto partition scheme here
}

void quickSortHoare( std::vector<int> &v ) {
    // Implement quick sort with Hoare partition scheme here
}
